...
use std::sync::Mutex;
//use web_audio_api::node::MediaElementAudioSourceOptions;
...
/*
#[frb(opaque)]
pub struct TauMediaElementAudioSourceOptions<'a>(pub(crate) Mutex<MediaElementAudioSourceOptions<'a>>);


#[delegate(self.0.lock().unwrap())]
impl TauMediaElementAudioSourceOptions<'_> {
    pub fn dummy(&self) {}
}
    */