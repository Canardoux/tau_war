...
const String _libName = 'tau_war';

/// The dynamic library in which the symbols for [TauWarBindings] can be found.
...
final TauWarBindings _bindings = TauWarBindings(_dylib);
